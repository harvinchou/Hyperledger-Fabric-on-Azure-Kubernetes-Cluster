...
export const builder = (yargs: Argv): Arguments =>
    yargs
        ...
        .option("fileshare", {
            ...
            alias: "f",
            description:
                "The azure file share url to download MSP. Should be in format: https://$STORAGE_ACCOUNT.file.core.chinacloudapi.cn/$STORAGE_FILE_SHARE?$SAS_TOKEN. On Windows please wrap argument in triple quotes!"
        }).argv;
